...
//    private ArrayList<com.tramontaz.snake.common.Point> snake = new ArrayList<>();
//    private int direction;
//
//    Snake(int x, int y, int length, int direction) {
//        for (int i = 0; i < length; i++) {
//            com.tramontaz.snake.common.Point point = new com.tramontaz.snake.common.Point("images/snake_body2.png" ,x - i, y);
//            snake.add(point);
//        }
...
//        for (com.tramontaz.snake.common.Point point : snake) {
//            point.paint(g);
//        }
//    }
//
...
//        snake.add(0, new com.tramontaz.snake.common.Point("images/snake_body2.png" ,x, y));
...
//    }
//
//    private boolean isFood(com.tramontaz.snake.common.Point food) {
